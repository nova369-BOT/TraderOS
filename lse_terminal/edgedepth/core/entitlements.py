# entitlements.h — exact port line by line, space by space, bracket by bracket, as is
# Original: edgedepth-terminal/src/core/entitlements.h from https://github.com/edgedepthhq/edgedepth-terminal.git
...
inline std::string free_window_label() {
    ...
    fmt(s, sb, sizeof(sb));
    fmt(e, eb, sizeof(eb));
    // ASCII "to" (not a → glyph - the mono atlas has no U+2192, it renders a
ORIGINAL C++ END
"""
...
# See docs/edgedepth_original/src/core/entitlements.h for verbatim original

class EntitlementsManager:
    """Ported from entitlements.h"""
    pass
