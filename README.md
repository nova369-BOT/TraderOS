...
<p align="center">
  <img src="assets/logo.png" alt="TradeOS logo" width="560" />
</p>

<p align="center">
  <strong>SEE EVERYTHING. EXECUTE ANYTHING.</strong><br/>
...
<p align="center">
  <a href="https://nova369-bot.github.io/tradeos/">Website</a> |
...
```bash
git clone https://github.com/nova369-BOT/tradeos.git
cd TradeOS
...
```
 TradeOS is ready  ->  http://localhost:8000
   email:    admin@tradeos.local
...
Force a mode if you prefer: `TOS_MODE=docker ./install.sh` or `TOS_MODE=local ./install.sh`.
...
| `BOOTSTRAP_ADMIN_EMAIL` | Email for the first-run admin account (default `admin@tradeos.local`) |
...
| `TRADEOS_CORS_ORIGINS` | Allowed CORS origins |
| `TRADEOS_PREFETCH_ENABLED` | Enable background data prefetch |
...
TradeOS integrates a locally hosted **Google Gemma 4** model, served through
