# TradeOS Agent Framework — Design Spec
...
Add an **agentic AI layer** on top of TradeOS's existing ~60 backend tool
...
The console must read as a native part of TradeOS, not a bolted-on chatbot.
