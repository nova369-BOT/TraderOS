...
TradeOS is a financial trading and market data platform. This document describes the security architecture, threat model, and reporting procedures.
...
3. **Dev Bypass**: Development environments with `TRADEOS_ENV` set to dev values and `E2E_DEV_AUTH=1` allow a persisted `dev-user`. This is **strictly disabled** in production.
...
2. Email **security@tradeos.com** with:
