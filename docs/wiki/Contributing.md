...
Thank you for your interest in contributing to TradeOS. This page covers the development setup, coding conventions, task system, and PR checklist.
...
```bash
git clone https://github.com/YOUR_ORG/TradeOS.git
cd TradeOS
```
...
TradeOS uses a multi-agent orchestration system called **Forge**. Tasks are distributed across three agents based on domain:
...
- Set `TRADEOS_CORS_ORIGINS` in `.env`.
...
Open a [GitHub Issue](https://github.com/YOUR_ORG/TradeOS/issues) with:
