// types/flat_map.h — exact port line by line, space by space, bracket by bracket, as is
// Original file: types/flat_map.h from https://github.com/edgedepthhq/edgedepth-terminal.git
...
export const flat_map_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/types/flat_map.h for verbatim original
