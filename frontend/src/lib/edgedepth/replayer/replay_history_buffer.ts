// replayer/replay_history_buffer.cpp — exact port line by line, space by space, bracket by bracket, as is
// Original file: replayer/replay_history_buffer.cpp from https://github.com/edgedepthhq/edgedepth-terminal.git
...
export const replay_history_buffer_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/replayer/replay_history_buffer.cpp for verbatim original
