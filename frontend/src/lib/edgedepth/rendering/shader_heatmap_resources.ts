// rendering/shader_heatmap_resources.cpp — exact port line by line, space by space, bracket by bracket, as is
// Original file: rendering/shader_heatmap_resources.cpp from https://github.com/edgedepthhq/edgedepth-terminal.git
...
export const shader_heatmap_resources_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/rendering/shader_heatmap_resources.cpp for verbatim original
