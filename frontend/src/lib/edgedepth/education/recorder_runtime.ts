// education/recorder_runtime.cpp — exact port line by line, space by space, bracket by bracket, as is
// Original file: education/recorder_runtime.cpp from https://github.com/edgedepthhq/edgedepth-terminal.git
...
void RecorderRuntime::render_overlay(const AppContext& ctx) {
    ...
    if (fade_box_.valid && lightbox_alpha_ > 0.01f) {
        ...
        // panel must pop while the ch
ORIGINAL C++ END */

export const recorder_runtime_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/education/recorder_runtime.cpp for verbatim original
