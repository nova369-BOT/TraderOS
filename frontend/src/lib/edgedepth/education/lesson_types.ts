// education/lesson_types.h — exact port line by line, space by space, bracket by bracket, as is
// Original file: education/lesson_types.h from https://github.com/edgedepthhq/edgedepth-terminal.git
...
export const lesson_types_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/education/lesson_types.h for verbatim original
