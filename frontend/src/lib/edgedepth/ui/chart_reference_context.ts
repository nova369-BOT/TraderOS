// ui/chart_reference_context.cpp — exact port line by line, space by space, bracket by bracket, as is
// Original file: ui/chart_reference_context.cpp from https://github.com/edgedepthhq/edgedepth-terminal.git
...
export const chart_reference_context_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/ui/chart_reference_context.cpp for verbatim original
