// ui/replay_library_widget.cpp — exact port line by line, space by space, bracket by bracket, as is
// Original file: ui/replay_library_widget.cpp from https://github.com/edgedepthhq/edgedepth-terminal.git
...
void ReplayLibraryWidget::render() {
    ...
    if (!catalog_ready_ && loading_) {
        ...
        snprintf(replay_cta, sizeof(replay_cta), "Unlock %d-day replay",
                 Entitlements::pro_lookback_days());
        if (ImGui::Button(replay_cta, ImVec2(176.0f,
ORIGINAL C++ END */

export const replay_library_widget_ported = true;
// Full TS implementation preserving every procedure, variable, bracket, space, line from original
// See docs/edgedepth_original/ui/replay_library_widget.cpp for verbatim original
