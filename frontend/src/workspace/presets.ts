...
export const WORKSPACE_PRESET_CONFIGS: Record<WorkspacePreset, WorkspacePresetConfig> = {
  trader: {
    ...
    landing: {
      ...
      primaryRoute: "/terminal/chart-workstation",
    ...
    quickLinks: [
      { to: "/terminal/chart-workstation", label: "Charts" },
      { to: "/markets/stocks", label: "Quote" },
      { to: "/portfolio/watchlists", label: "Watchlist" },
      { to: "/ops/alerts", label: "Alerts" },
      { to: "/terminal/paper", label: "Paper" },
      { to: "/terminal/tape", label: "Tape" },
    ],
  ...
  quant: {
    ...
    quickLinks: [
      { to: "/markets/screener", label: "Screener" },
      { to: "/labs", label: "Backtest" },
      { to: "/labs/model-lab", label: "Model Lab" },
      { to: "/labs/factors", label: "Factors" },
      { to: "/terminal/chart-workstation", label: "Charts" },
      { to: "/markets/rs", label: "RS" },
    ],
  ...
  pm: {
    ...
    quickLinks: [
      ...
      { to: "/portfolio/lab", label: "Lab" },
      { to: "/portfolio/risk", label: "Risk" },
      { to: "/portfolio/correlation", label: "Corr" },
      { to: "/markets/news", label: "News" },
      { to: "/markets/security", label: "Security" },
    ],
  ...
  risk: {
    ...
    quickLinks: [
      ...
      { to: "/ops/alerts", label: "Alerts" },
      { to: "/portfolio", label: "Portfolio" },
      { to: "/markets/heatmap", label: "Heatmap" },
    ],
  ...
  ops: {
    ...
    quickLinks: [
      { to: "/ops", label: "Ops" },
      { to: "/ops/data-quality", label: "Data" },
      { to: "/portfolio/oms", label: "OMS" },
      { to: "/ops/plugins", label: "Plugins" },
