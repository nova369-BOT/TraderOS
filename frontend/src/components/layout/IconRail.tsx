...
const RAIL_ITEMS: RailItem[] = [
  ...
  { id: "market", label: "Market", glyph: "MK", to: "/markets/stocks" },
  { id: "workstation", label: "Workstation", glyph: "WS", to: "/terminal/chart-workstation" },
  { id: "launchpad", label: "Launchpad", glyph: "LP", to: "/launchpad" },
  { id: "screener", label: "Screener", glyph: "SC", to: "/markets/screener" },
  { id: "alpha-zoo", label: "Alpha", glyph: "AZ", to: "/labs/alpha-zoo" },
  { id: "research-autopilot", label: "Research", glyph: "RA", to: "/markets/research-autopilot" },
  { id: "strategy-export", label: "Export", glyph: "EX", to: "/labs/strategy-export" },
  { id: "portfolio", label: "Portfolio", glyph: "PF", to: "/portfolio" },
  { id: "shadow-account", label: "Shadow", glyph: "SA", to: "/portfolio/shadow-account" },
  { id: "watchlist", label: "Watchlist", glyph: "WL", to: "/portfolio/watchlists" },
  { id: "news", label: "News", glyph: "NW", to: "/markets/news" },
  { id: "alerts", label: "Alerts", glyph: "AL", to: "/ops/alerts" },
  { id: "settings", label: "Settings", glyph: "ST", to: "/settings" },
];
