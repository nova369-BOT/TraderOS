...
const DEFAULT_SHORTCUTS: KeyboardShortcut[] = [
  ...
  { id: "market-heatmap", label: "Market Heatmap", keys: "g h", action: "/markets/heatmap", category: "navigation" },
  { id: "screener", label: "Screener", keys: "g s", action: "/markets/screener", category: "navigation" },
  { id: "portfolio", label: "Portfolio", keys: "g p", action: "/portfolio", category: "navigation" },
  { id: "watchlist", label: "Watchlist", keys: "g w", action: "/portfolio/watchlists", category: "navigation" },
