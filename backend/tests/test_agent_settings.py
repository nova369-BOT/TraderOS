...
def test_agent_defaults(monkeypatch):
    for var in [
        ...
        "TRADEOS_OPENROUTER_BASE_URL", "OPENROUTER_BASE_URL",
        "TRADEOS_AGENT_PROVIDER", "AGENT_PROVIDER",
        "TRADEOS_AGENT_MODEL", "AGENT_MODEL",
        "TRADEOS_AGENT_DISABLE_MODEL_FALLBACKS", "AGENT_DISABLE_MODEL_FALLBACKS",
        "TRADEOS_AGENT_MODELS_TOOL_USE", "AGENT_MODELS_TOOL_USE",
        "TRADEOS_AGENT_MODELS_REASONING", "AGENT_MODELS_REASONING",
        "TRADEOS_AGENT_MODELS_GENERAL", "AGENT_MODELS_GENERAL",
        "TRADEOS_AGENT_MAX_STEPS", "TRADEOS_AGENT_TIMEOUT_SECONDS",
    ]:
